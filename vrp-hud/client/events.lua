...
RegisterNetEvent("vrp-hud:Client:HandleCallback", function(key, data)
...
RegisterNetEvent("vrp-hud:Client:OpenHudSettings", function()
    SetNuiFocus(true, true)
    Koci.Client:SendReactMessage("setRouter", "settings")
end)
RegisterNetEvent("vrp-hud:Client:HiddenHudElement", function(element, code)
    Koci.Client:SendReactMessage("HIDDEN_HUD_ELEMENT", {
        element = element,
        code = code
    })
end)
RegisterNetEvent("vrp-hud:Client:ShowHudElement", function(element, code)
    Koci.Client:SendReactMessage("SHOW_HUD_ELEMENT", {
        element = element,
        code = code
    })
end)
RegisterNetEvent("vrp-hud:Client:SetManualGear", function(newGear)
...
elseif GetResourceState("saltychat") == "started" then
    ...
    TriggerServerEvent("vrp-hud:Server:ErrorHandle", "Setup your custom voice resource at: client/utils.lua")
